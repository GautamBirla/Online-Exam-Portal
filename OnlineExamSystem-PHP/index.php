  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Develop</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="Gautam_Passport.jpg" width=100 height=100 alt="Gautam Birla" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Gautam Birla</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+917877892186</h4>
		<h4 style="font-family:'typo' ">birlagautam50@gmail.com</h4>
		<h4 style="font-family:'typo' ">Poornima University, Jaipur</h4></div></div>
		</p>
      </div>
